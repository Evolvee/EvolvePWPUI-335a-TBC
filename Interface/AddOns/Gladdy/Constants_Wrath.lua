...
local importantAuras = {
	...
	[GetSpellInfo(58373)] = { -- Glyph of Hamstring
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 58373,
	},
	...
	[GetSpellInfo(64695)] = { -- Earthgrab (Totem)
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 64695,
	},
	[GetSpellInfo(48999)] = { -- Counterattack
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 48999,
	},
	[GetSpellInfo(64804)] = { -- Entrapment
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 64804,
	},
	[GetSpellInfo(53548)] = { -- Pin (Hunter Pet)
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 53548,
	},
	[GetSpellInfo(55509)] = { -- Venom Web Spray (Hunter Pet)
		track = AURA_TYPE_DEBUFF,
		priority = 30,
		spellID = 55509,
	},
	...
	[GetSpellInfo(17308)] = { -- Stun (Paladin Seal) - 20170
		track = AURA_TYPE_DEBUFF,
		priority = 40,
		spellID = 17308,
	},
	...
	[select(1, GetSpellInfo(64058)) .. " Disarm"] = { -- Psychic Horror Disarm
		track = AURA_TYPE_DEBUFF,
		altName = select(1, GetSpellInfo(64058)) .. " Disarm",
		priority = 20,
		spellID = 64058,
	},
