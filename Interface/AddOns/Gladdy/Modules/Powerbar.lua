...
function Powerbar:CreateFrame(unit)
    ...
    self:ResetUnit(unit)
    powerBar.unit = unit
    powerBar:RegisterUnitEvent("UNIT_ENERGY", unit)
    powerBar:RegisterUnitEvent("UNIT_RAGE", unit)
    powerBar:RegisterUnitEvent("UNIT_MANA", unit)
    powerBar:RegisterUnitEvent("UNIT_RUNIC_POWER", unit)
    powerBar:RegisterUnitEvent("UNIT_MAXENERGY", unit)
    powerBar:RegisterUnitEvent("UNIT_MAXRAGE", unit)
    powerBar:RegisterUnitEvent("UNIT_MAXMANA", unit)
    powerBar:RegisterUnitEvent("UNIT_MAXRUNIC_POWER", unit)
...
function Powerbar:UpdateFrame(unit)
    ...
    if not Gladdy.db.powerBarEnabled then
        powerBar:Hide()
        powerBar:UnregisterEvent("UNIT_ENERGY", unit)
	    powerBar:UnregisterEvent("UNIT_RAGE", unit)
	    powerBar:UnregisterEvent("UNIT_MANA", unit)
	    powerBar:UnregisterEvent("UNIT_RUNIC_POWER", unit)
	    powerBar:UnregisterEvent("UNIT_MAXENERGY", unit)
	    powerBar:UnregisterEvent("UNIT_MAXRAGE", unit)
	    powerBar:UnregisterEvent("UNIT_MAXMANA", unit)
	    powerBar:UnregisterEvent("UNIT_MAXRUNIC_POWER", unit)
	    powerBar:UnregisterEvent("UNIT_DISPLAYPOWER", unit)
