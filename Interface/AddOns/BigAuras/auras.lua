...
BigAurasSpells.spells = {
    ...
    --immunity
        ...
        [23920] = {category = "immunity",priority = 1},
            [43443] = {parent = 23920},
            [59725] = {parent = 23920},
		[6346] = {category = "immunity",priority = 1}, -- Fear Ward
		[8178] = {category = "immunity",priority = 1},  -- Grounding Totem Effect
		[5024] = {category = "immunity",priority = 1}, -- Flee (Skull of Impending doom cancer)
		[7744] = {category = "immunity",priority = 1}, -- WOTF
    ...
    --crowdControl
		...
		[16922]= {category = "crowdControl",priority = 1},  -- Starfire Stun
		[19410]= {category = "crowdControl",priority = 1},  -- Improved Concussive Shot
		[15269]= {category = "crowdControl",priority = 1},  -- Blackout
		[18093]= {category = "crowdControl",priority = 1},  -- Pyroclasm
		[5530]= {category = "crowdControl",priority = 1},  -- Mace Stun
		[34510]= {category = "crowdControl",priority = 1},  -- Stunherald
		[25046]= {category = "crowdControl",priority = 1},  -- Arcane Torrent 1
		[28730]= {category = "crowdControl",priority = 1},  -- Arcane Torrent 2
		[30457]= {category = "crowdControl",priority = 1},  -- Complete Vulnerability (ENG belt backfire)
		[20549]= {category = "crowdControl",priority = 1},	-- War Stomp
		[15753]= {category = "crowdControl",priority = 1},	-- Knockdown (Boomerang)
    ...
    --defensive
        ...
        [16188] = {category = "defensive",priority = 1}, -- Nature's Swiftness (Shaman)
		[17116] = {category = "defensive",priority = 1}, -- Nature's Swiftness (Druid)
		[12051] = {category = "defensive",priority = 1}, -- Evocation
        ...
        [1044] = {category = "defensive",priority = 1}, -- Blessing of Freedom
        [6940] = {category = "defensive",priority = 1}, -- Blessing of Sacrifice
            [1022] = {parent =10278},
            [5599] = {parent =10278},
		...
		[31230] = {category = "defensive",priority = 1}, -- Cheat Death
			[31229] = {parent = 31230},
			[31228] = {parent = 31230},
			[31231] = {parent = 31230},
			[45182] = {parent = 31230},
		[30458] = {category = "defensive",priority = 1}, -- 4k absorb ENG Belt
		[30456] = {category = "defensive",priority = 1}, -- 4k absorb ENG Belt
		[27009] = {category = "defensive",priority = 1}, -- Nature's Grasp
			[16810] = {parent = 27009},
			[16811] = {parent = 27009},
			[16812] = {parent = 27009},
			[16813] = {parent = 27009},
			[17329] = {parent = 27009},
			[16689] = {parent = 27009},
		[7812] = {category = "defensive",priority = 1}, -- Sacrifice (Voidwalker)
			[19438] = {parent = 7812},
			[19440] = {parent = 7812},
			[19441] = {parent = 7812},
			[19442] = {parent = 7812},
			[19443] = {parent = 7812},
			[27273] = {parent = 7812},
		[20594] = {category = "defensive",priority = 1}, -- Stoneform
    ...
    --other
		...
		[768] = {category = "other", priority = 1}, -- Cat Form
		[5487] = {category = "other", priority = 1}, -- Bear Form
        [9634] = {category = "other", priority = 1}, -- Dire Bear Form
        [24858] = {category = "other", priority = 1}, -- Moonkin Form
		[33891] = {category = "other", priority = 1}, -- Tree Form
		[783] = {category = "other", priority = 1}, -- Travel Form
		...
		[770] = {category = "other", priority = 1}, -- Fearie Fire (priest dispel prio for PartyFrames)
			...
			[9907] = {parent = 770},
			[26993] = {parent = 770},
		[16857] = {category = "other", priority = 1}, -- FERAL Fearie Fire (priest dispel prio for PartyFrames)
			[17390] = {parent = 16857},
			[17391] = {parent = 16857},
			[17392] = {parent = 16857},
			[27011] = {parent = 16857},
