...
local MOVANY = {
	...
	DISABLE_CONTAINER_HOOK = "Disable bag container hook",
	DISABLE_CONTAINER_HOOK_DESC = "Toggles if MoveAnything will hook containers.\n\nThis should be checked if you use another addon to move your bags.",
	DISABLE_ERROR_MESSAGES = "Disable error messages",
	DISABLE_ERROR_MESSAGES_DESC = "Toggles printing of error messages on/off.",
	DISABLE_FRAME_HOOK = "Disable frame creation hook",
	DISABLE_FRAME_HOOK_DESC = "Toggles if MoveAnything will hook CreateFrame.\n\nRequires reload to take effect.",
	DISABLE_MINIMAP_MOUSEWHEEL_ZOOM = "Disable Minimap mousewheel zoom",
	DISABLE_MINIMAP_MOUSEWHEEL_ZOOM_DESC = "Toggles Minimap mousewheel zoom on/off.\n\nRequires reload to take effect.",
	DISABLE_OOC_SYNC = "Disable sync when leaving combat",
	DISABLE_OOC_SYNC_DESC = "Toggles if MoveAnything will synchronize pending frames when leaving combat.\n\nDisabling this may result in protected frames requiring a manual sync when leaving combat.",
	DONT_SEARCH_FRAME_NAMES = "Dont search frame names",
	DONT_SEARCH_FRAME_NAMES_DESC = "Disables searching of actual frame names.",
	ELEMENT_NOT_FOUND = "UI element not found",
	ELEMENT_NOT_FOUND_NAMED = "UI element not found: %s",
	ENABLE_NUDGER = "Enable to show the nudger with the main window\n\nBy default the Nudger is only shown when interacting with frames.",
	ENABLE_SQUARE_MINIMAP = "Enable square Minimap",
	ENABLE_SQUARE_MINIMAP_DESC = "Toggles square MiniMap on/off.\n\nHide \"Round Border\" in the \"Minimap\" category to get rid of the overlaying border.",
	...
	ESCAPE_KEY_DESC = "Escape key closes main window",
	...
	PLAY_SOUND_DESC = "Toggles if MoveAnything should play a sound when opening and closing the main window.",
	...
	RESET_ALL_PROFILE = "Reset All",
	RESET_ALL_PROFILE_DESC = "Reset all\n\nReset MoveAnything to default settings. Deletes all frame settings, as well as the custom frame list",
	RESET_FRAME_CONFIRM = "Reset %s? Press again within 5 seconds to confirm",
	RESET_PROFILE = "Reset Profile",
	RESET_PROFILE_DESC = "Reset profile\n\nResets the profile, deleting all stored frame settings for this profile.",
	SAVE = "Save",
	SAVE_AS = "Save as",
	SEARCH_TEXT = "Search",
	SHOW_NUDGER = "Show Nudger with main window",
	SHOW_ONLY_MODIFIED = "Show only modified frames",
	SHOW_TOOLTIPS = "Show tooltips",
	SHOW_TOOLTIPS_DESC = "Toggles display of tooltips on/off\n\nPressing Shift when mousing over elements will reverse tooltip display behavior.",
	SYNC_ELEMENTS = "Synchronize elements modified by MoveAnything",
	TOGGLE_ALL = "Toggles all movers",
	TOGGLE_ALL_CATS = "Toggle all categories",
	TOGGLE_FSTACK = "Toggle Blizzard's framestack tooltip\n\n A very helpful tool for finding frame names for use with /move or /hide",
	TOGGLE_OPTIONS = "Toggle options",
	TOGGLE_VISIBILITY = "Toggle visibility on frame editors",
