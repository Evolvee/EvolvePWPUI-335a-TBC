    ...
    if numButtons < maxButtons then
        for i = numButtons + 1, maxButtons do
            ...
            if freeButtons[categoryFrame][i] then
                ...
                button = _G[name .. "Button" .. i] or
                             CreateFrame("BUTTON", name .. "Button" .. i, categoryFrame,
...
local grip = _G.BetterBlizzOptionsResizeGrip or
                 CreateFrame("Frame", "BetterBlizzOptionsResizeGrip", InterfaceOptionsFrame)
...
if not InterfaceOptionsFrameAddOns:IsMouseWheelEnabled() then
    ...
    InterfaceOptionsFrameAddOns:SetScript("OnMouseWheel", function(self, dir)
        InterfaceOptionsFrameAddOnsListScrollBar:SetValue(InterfaceOptionsFrameAddOnsListScrollBar:GetValue() -
                                                              (dir * 18))
    end)
end
...
InterfaceOptionsFrame:SetMinResize(826, 584) -- 858, 660
InterfaceOptionsFrame:SetToplevel(true)

InterfaceOptionsFrame:HookScript("OnShow", function()
    InterfaceOptionsFrame:SetSize(826, 584); -- 858, 660
    InterfaceOptionsFrame:SetMinResize(826, 584); -- 858, 660
end)
